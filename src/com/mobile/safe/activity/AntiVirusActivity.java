...
import com.mobile.safe.db.dao.AntivirusDao;
		...
		public void handleMessage(android.os.Message msg) {
			...
			case SCAN_FINISH:
				...
				if(virusInfos.size()>0){//发现了病毒
					...
					Toast.makeText(AntiVirusActivity.this, "您的手机非常安全，继续加油哦",0).show();
		...
		new Thread() {
			public void run() {
				...
				for (PackageInfo packinfo : packinfos) {
					...
					String md5 = MD5Utils.md5Encode(packinfo.signatures[0].toCharsString());
